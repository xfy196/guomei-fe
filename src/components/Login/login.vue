<template>
  <div id="login-page">
    <!-- 退出按钮 -->
    <van-icon name="cross" class="back-btn" color="#666666" @click="goBack"/>
    <!-- logo -->
    <div class="logo">
        <img src="https://gfs10.gomein.net.cn/wireless/T1XqAyBXb_1RCvBVdK_660_360.png" alt="">
    </div>
    <!-- 登录表单 -->
